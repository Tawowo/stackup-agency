      ...
      <div className="grid sm:grid-cols-3 gap-4">
        {related.map(post => (
          <Link
            key={post.slug}
            href={`/blog/${post.slug}`}
            className="group p-4 rounded-xl border border-white/10 hover:border-blue-500/30 transition-colors"
          >
            ...
            <h4 className="text-sm font-semibold text-foreground dark:text-white mb-2 group-hover:text-blue-400 transition-colors line-clamp-2">
              {post.title}
            </h4>
