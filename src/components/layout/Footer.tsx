      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/mentions-legales" className="text-white/50 hover:text-white text-sm transition-colors">
                  {t.footer.mentions}
                </a>
              </li>
              <li>
                <a href="/politique-confidentialite" className="text-white/50 hover:text-white text-sm transition-colors">
                  {t.footer.privacy}
                </a>
              </li>
              <li>
                <a href="mailto:contact@stackup.agency" className="text-white/50 hover:text-white text-sm transition-colors">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/20 text-xs">Fait avec ❤️ par Mathéo</p>
        </div>
      </div>
    </footer>
  )
