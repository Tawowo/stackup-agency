          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={s.titre} className={`rounded-2xl border p-6 flex flex-col ${s.highlight ? 'border-amber-500/40 bg-amber-500/5' : 'border-navy/20 dark:border-white/10'}`}>
                {s.highlight && <div className="text-xs font-semibold text-amber-500 mb-3 uppercase tracking-wide">Le plus populaire</div>}
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-lg font-bold text-foreground dark:text-white">{s.titre}</h3>
                  <span className="text-2xl font-bold text-amber-500 ml-3">{s.prix}€</span>
                </div>
                ...
                <div className="text-xs text-foreground/50 dark:text-white/40 mb-4">Livraison : {s.delai}</div>
                <Link href={s.href} className={`flex items-center justify-center gap-1 py-2.5 rounded-xl text-sm font-semibold transition-colors ${s.highlight ? 'bg-amber-500 hover:bg-amber-400 text-white' : 'border border-white/20 text-white hover:bg-white/10'}`}>
        ...
        <section className="rounded-2xl border border-blue-500/30 bg-blue-500/5 p-6 lg:p-8">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
            ...
            <div className="text-right flex-shrink-0">
              <div className="text-3xl font-bold text-blue-400">à partir de {SITE.pricing.gestion}€</div>
              <div className="text-xs text-foreground/50 dark:text-white/50 mt-0.5">Livraison : 4 semaines</div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/contact" className="px-5 py-2.5 border border-white/20 text-white hover:bg-white/10 text-sm font-semibold rounded-xl transition-colors">
              Demander un devis
            </Link>
          </div>
        </section>
            ...
            {[
              ...
              <div key={m.titre} className="rounded-2xl border border-navy/20 dark:border-white/10 p-5">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xl font-bold text-amber-500">{m.prix}€<span className="text-sm font-normal text-foreground/50 dark:text-white/50">/mois</span></span>
                </div>
