...
### Photos : l'investissement le plus rentable

Pour un restaurant, les photos sont le contenu le plus impactant. L'ordre d'importance :

1. **Photos de plats** (les plus importantes pour déclencher l'envie)
2. **Ambiance intérieure** (soir de service, décoration)
3. **Terrasse** (si vous en avez une — c'est un critère de recherche fréquent)
4. **Photo de l'équipe** (le chef, la brigade — crée de l'attachement)
5. **Extérieur de l'établissement** (pour aider les clients à vous trouver)
...
### Votre site web : un outil de conversion et de SEO
...
- Accueil avec photo d'ambiance forte, bouton de réservation visible, horaires et adresse
- Menu en HTML (pas en PDF) — idéalement avec des sous-pages par type de plat
- Réservation avec formulaire ou lien vers votre système de réservation
- Contact avec carte Google Maps intégrée
- À propos / Histoire — le storytelling qui crée la différence

**L'optimisation SEO des pages :**
- Titre de page : "Restaurant [cuisine] à [ville] | [Nom du restaurant]"
- Balise H1 : "[Nom du restaurant] — [cuisine] au cœur de [quartier/ville]"
- Contenu textuel avec mentions naturelles de la ville, du quartier, du type de cuisine
...
### Gérer votre réputation en ligne sur tous les canaux
...
### Exploiter le contenu saisonnier
...
- Créez des pages dédiées pour chaque événement (menu Saint-Valentin, menu de fête, brunch dominical)
- Publiez vos offres saisonnières 4 à 6 semaines à l'avance
- Utilisez les Posts GBP pour communiquer sur vos événements en temps réel
